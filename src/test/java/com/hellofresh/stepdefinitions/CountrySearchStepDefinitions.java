...
import com.hellofresh.steps.UserSearchSteps;
...
public class CountrySearchStepDefinitions {
	...
	public void response_includes_the_following(String message) {
		userSearchSteps.iShouldFindNoMatchResponse(message);
	}
